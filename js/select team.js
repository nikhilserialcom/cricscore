...
const my_team_div = document.querySelector('.my_team');
const my_team_list = document.querySelector('.my_team_list');
const search_team_div = document.querySelector('.search_team');
const select_team_btn = document.querySelector('.select_team_btn button');
...
list_ul[0].onclick = function () {
    resetactive();
    list_ul[0].classList.add('sub_color');
    const active_div = document.querySelector('.active');
    if(active_div)
    {
        active_div.classList.remove('active');
    }
    outer_all.classList.add('active');
}
...
var showAllteam = () => {
    fetch(showteamUrl, {
        ...
        .then(json => {
            ...
            var arr = json.arr;
            if (json.status_code == 200) {
                my_team_list.innerHTML = arr.map(val => {
...
list_ul[1].onclick = function () {
    ...
    my_team_div.classList.add('active');
    showAllteam();
}
...
list_ul[2].onclick = function () {
    ...
    search_team_div.classList.add('active');
}
